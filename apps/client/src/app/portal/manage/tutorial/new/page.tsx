...
import { ArrowLeft, Save, Send, UploadCloud, Loader2, Ban, Package, Type, FileText } from "lucide-react";
...
export default function CreateUserArticlePage() {
  ...
  const onSaveDraft = async () => {
    ...
    try {
      ...
      // ✅ biarkan overlay tetap tampil sampai pindah halaman
